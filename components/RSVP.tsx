      ...
      {confirmed ? (
        ...
        <>
          ...
          <p className="text-center  md:w-1/2 pt-6">
            Les sugerimos limitar las salidas 2 semanas previas a la boda y
            durante el evento tomar todas las medidas de bioseguridad posible
            para que todos estemos tranquilos y disfrutemos!
          </p>
        </>
      )}
    </section>
